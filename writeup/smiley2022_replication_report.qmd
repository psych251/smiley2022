...
is a fundamental human panic about new technologies. In the 1800s, novels were accused of corrupting the minds of youth and housewives, in the 1940s "television addiction" was coined, and in current discourse smartphones and social media are the supposed culprits behind adolescents' declining mental health. (See [Pessimists Archive](https://pessimistsarchive.org/) for more examples.) Because my research investigates people's
...
The original effect size from Smiley and Fisher (2022) was *d* = .25. As in the original paper, I aimed for 80% power with a medium effect size of *d* = .3. 
